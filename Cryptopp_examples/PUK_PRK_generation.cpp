...
int main(int argc, char** argv) {
  std::string publicKeyName = "/home/mohamed/crypto/Key_Generations/public.key";    // Filename for the public key
  std::string privateKeyName = "/home/mohamed/crypto/Key_Generations/private.key";  // Filename for the private key
